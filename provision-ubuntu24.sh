...
log "Starting Servura server provisioning for Ubuntu 24.04 LTS..."

# Check Ubuntu version
UBUNTU_VERSION=$(lsb_release -rs)
if [[ "$UBUNTU_VERSION" != "24.04" ]]; then
    warn "This script is optimized for Ubuntu 24.04. You are running $UBUNTU_VERSION"
...
# Install PHP 8.3 and extensions (Ubuntu 24.04 has PHP 8.3 in default repos)
...
apt install -y php8.3 php8.3-fpm php8.3-mysql php8.3-xml php8.3-mbstring \
    ...
    php8.3-sqlite3 php8.3-opcache php8.3-redis

# Try to install ImageMagick PHP binding
if apt install -y php8.3-imagick 2>/dev/null; then
...
if ! id "servura" &>/dev/null; then
    ...
    log "Created servura user"
else
    log "Servura user already exists"
fi
...
systemctl enable php8.3-fpm nginx mysql redis-server fail2ban

systemctl restart php8.3-fpm nginx redis-server
...
echo ""
echo "=================================="
echo "🎉 SERVURA SERVER SETUP COMPLETED!"
echo "=================================="
echo ""
echo "📋 IMPORTANT INFORMATION:"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "🔧 PHP Version: 8.3"
echo "🗄️  Database password saved to: /etc/servura/db_credentials"
...
echo "📝 NEXT STEPS:"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "1️⃣  Configure your domain name in /etc/nginx/sites-available/servura"
echo "2️⃣  Set up SSL with: certbot --nginx -d your-domain.com"
echo "3️⃣  Clone the repository:"
echo "    sudo -u servura git clone https://github.com/Tstrngt/Servura.git /var/www/Servura"
echo "4️⃣  Copy .env.example to .env and configure with database password above"
echo "5️⃣  Deploy your application:"
echo "    sudo -u servura ./deploy.sh"
echo ""
echo "🔍 SYSTEM STATUS:"
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
...
echo ""
echo "🌐 Your server is ready! Configure your domain and deploy the application."
echo "=================================="
