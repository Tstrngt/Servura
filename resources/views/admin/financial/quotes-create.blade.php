            ...
            <form method="POST" action="{{ route('admin.financial.quotes.store') }}" id="quoteForm">
                ...
                <div class="bg-white shadow rounded-lg p-6 mb-6">
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="valid_days" value="30" min="1" max="90" class="form-input w-full">
                        </div>
                        <div>
                ...
                <div class="bg-white shadow rounded-lg p-6 mb-6">
                    ...
                    <div class="mb-3 grid grid-cols-12 gap-3">
                        ...
                        <div class="col-span-2"><span class="block text-sm font-medium text-gray-700">Type</span></div>
                        <div class="col-span-1"><span class="block text-sm font-medium text-gray-700">Totaal</span></div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function createLine(description, quantity, unitPrice, serviceId, priceType) {
        ...
        row.innerHTML =
            ...
            '</div>' +
            '<div class="col-span-1 text-sm font-medium line-total">€0,00</div>' +
            '<div class="col-span-1">' +
    ...
    container.addEventListener('input', function(e) {
        if (e.target.classList.contains('line-qty') || e.target.classList.contains('line-price')) recalc();
    });
});
</script>
@endsection
