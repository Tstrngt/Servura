...
<!-- Customer Top Bar -->
<div class="bg-slate-900 border-b border-slate-800 sticky top-0 z-30 lg:pl-64">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-16">
            <!-- Left: Brand label -->
            <div class="flex items-center gap-3">
                <span class="text-sm font-semibold text-white tracking-wide">Klantportaal</span>
                <span class="hidden sm:inline h-4 w-px bg-slate-700"></span>
                <span class="hidden sm:inline text-sm text-slate-400 truncate max-w-[200px]">{{ Auth::user()->email }}</span>
            </div>
...
<div class="bg-white border-b border-slate-200 sticky top-16 z-20 lg:pl-64 shadow-sm">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
