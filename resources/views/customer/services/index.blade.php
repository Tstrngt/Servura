...
<div class="bg-slate-50 min-h-screen lg:pl-64 pt-32">
    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                    ...
                    <div class="p-5">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-gray-500 truncate">Totaal Diensten</dt>
                ...
                <div class="bg-white overflow-hidden shadow rounded-lg">
                    <div class="p-5">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-gray-500 truncate">Actieve Diensten</dt>
                ...
                <div class="bg-white overflow-hidden shadow rounded-lg">
                    <div class="p-5">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-gray-500 truncate">Maandelijkse Kosten</dt>
                                    <dd class="text-lg font-medium text-gray-900">€{{ number_format($stats['monthly_cost'], 2, ',', '.') }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                ...
                <div class="bg-white overflow-hidden shadow rounded-lg">
                    <div class="p-5">
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    <dt class="text-sm font-medium text-gray-500 truncate">Jaarlijkse Kosten</dt>
                                    <dd class="text-lg font-medium text-gray-900">€{{ number_format($stats['yearly_cost'], 2, ',', '.') }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
        ...
        @if($activeServices->count() > 0)
            <div class="px-4 py-6 sm:px-0">
                <div class="bg-white shadow rounded-lg">
                    <div class="px-4 py-5 sm:p-6">
                        <h3 class="text-lg leading-6 font-medium text-gray-900 mb-4">Actieve Diensten</h3>
                        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                            @foreach($activeServices as $customerService)
                                <div class="border border-gray-200 rounded-lg p-4">
                                    <div class="flex items-center justify-between mb-2">
                                        <h4 class="text-md font-medium text-gray-900">{{ $customerService->service->title }}</h4>
                                    ...
                                    <p class="text-sm text-gray-600 mb-2">{{ $customerService->service->short_description }}</p>
                                    <div class="flex items-center justify-between text-sm">
                                        <span class="text-gray-500">{{ $customerService->formatted_price }}</span>
                                        @if($customerService->end_date)
                                            <span class="text-gray-500">t/m {{ $customerService->end_date->format('d-m-Y') }}</span>
                                        @endif
                                    </div>
                                </div>
                            @endforeach
            ...
            <div class="px-4 py-6 sm:px-0">
                <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4">
                    <div class="flex">
                        ...
                        <div class="ml-3">
                            <h3 class="text-sm font-medium text-yellow-800">Diensten die binnenkort verlopen</h3>
        ...
        <div class="px-4 py-6 sm:px-0">
            <div class="bg-white shadow rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    <h3 class="text-lg leading-6 font-medium text-gray-900 mb-4">Alle Diensten</h3>
                                    ...
                                    @foreach($allServices as $customerService)
                                        <tr>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="text-sm font-medium text-gray-900">{{ $customerService->service->title }}</div>
                                                <div class="text-sm text-gray-500">{{ $customerService->service->short_description }}</div>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $customerService->formatted_price }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $customerService->start_date->format('d-m-Y') }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">{{ $customerService->end_date ? $customerService->end_date->format('d-m-Y') : 'Onbeperkt' }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
                    ...
                    @else
                        <div class="text-center py-8">
                            ...
                            <p class="mt-1 text-sm text-gray-500">U heeft nog geen diensten afgenomen.</p>
                            <div class="mt-6">
