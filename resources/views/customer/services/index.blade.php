                        ...
                        @foreach($activeServices as $customerService)
                            ...
                            <div class="bg-slate-50 rounded-xl p-5 ring-1 ring-slate-200">
                                <div class="flex items-center justify-between mb-2">
                                    ...
                                    <span class="group relative inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-xs font-medium bg-emerald-100 text-emerald-800">
                                        Actief
                                        @if($isExpiringSoon)
                                            ...
                                            <span class="absolute bottom-full right-0 mb-2 hidden w-56 group-hover:block bg-slate-900 text-white text-xs rounded-lg px-3 py-2 shadow-lg z-10">
                                                Deze dienst verloopt op {{ $customerService->end_date->format('d-m-Y') }}. Neem contact op voor verlenging.
                                                <span class="absolute top-full right-3 -mt-1 border-4 border-transparent border-t-slate-900"></span>
                                            </span>
                                        @endif
                                    </span>
                                </div>
