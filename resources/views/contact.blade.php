    ...
    <div class="relative max-w-7xl mx-auto px-6 py-24 lg:py-32">
        <div class="max-w-2xl animate-slide-up">
            ...
            <div class="flex flex-col sm:flex-row gap-4">
                <a href="#contact-form" class="btn btn-primary px-7 py-3.5 shadow-lg shadow-primary-500/25">
                    Stuur een bericht
                </a>
                <a href="tel:0612345678" class="inline-flex items-center justify-center gap-2 font-medium text-white border border-white/20 bg-white/5 hover:bg-white/10 rounded-full px-7 py-3.5 transition-colors">
